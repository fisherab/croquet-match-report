...
class Croquet_Match_Report_Sanitize {
	...
	public function __construct() {
	  // this has setters rather than using the constructor
	} // __construct()
	...
	public function set_type( $type ) {
		...
		if ( empty( $type ) ) {
			...
			$check = new WP_Error( 'forgot_type', __( 'Specify the data type to sanitize.', 'croquet-match-report' ) );

		}

		if ( is_wp_error( $check ) ) {

			wp_die( $check->get_error_message(), __( 'Forgot data type', 'croquet-match-report' ) );
