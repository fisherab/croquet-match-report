 ...
 */
class Croquet_Match_Report_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$this->plugin_name 			= 'croquet_match_report';

		$name 					= esc_html__( 'Match Reports', 'croquet_match_report' );
		$opts['classname'] 		= '';
		$opts['description'] 	= esc_html__( 'Display match reports on a sidebar', 'croquet_match_report' );
	...
	function widget( $args, $instance ) {
		...
		include( plugin_dir_path( __FILE__ ) . 'partials/croquet-match-report-display-widget.php' );
