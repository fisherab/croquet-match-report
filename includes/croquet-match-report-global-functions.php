 ...
 */
function croquet_match_report_get_max( $array ) {

	return Croquet_Match_Report_Globals::get_max( $array );
 ...
 */
function croquet_match_report_get_svg( $svg ) {

	return Croquet_Match_Report_Globals::get_svg( $svg );
 ...
 */
function croquet_match_report_get_template( $name ) {

	return Croquet_Match_Report_Globals::get_template( $name );

}

class Croquet_Match_Report_Globals {
	 ...
	 */
 	public static function get_template( $name ) {
		 ...
		 */
		apply_filters( 'croquet-match-report-template-paths', $locations );
